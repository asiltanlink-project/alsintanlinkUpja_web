...
class View extends React.Component {
    ...
    showDownloadPdfUrl = () => {
        return (
            <Button className="mr-2" disabled={this.state.isDownloadPDFButtonDisabled} onClick={() => this.generateReceivePDF(this.state.currentNoReceive)}>Download PDF</Button>
        )
    }
    ...
    showReceiveHeader = () => {
        return (
            <Row>
                ...
                <Col xs="2">
                    <h6 style={{ fontWeight: 'bold' }}>Tanggal Receive </h6>
                    <h6 style={{ fontWeight: 'bold', marginTop: '16px' }}>
                        Penerima{' '}
                    </h6>
            ...
            <Page>
                <Card>
                    ...
                    <CardBody>
                        ...
                        {/* Navigate to Print preview button */}
                        <Row>
