...
import {
    ...
    Spinner, ButtonGroup, Modal, ModalBody, ModalFooter,
} from 'reactstrap';
import { MdSearch, MdDetails } from 'react-icons/md';
...
class SPAddHOPage extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.setTitle('SP ADD HO ' + gName, 'red');
    }
    ...
    openDetail = (nosp, outcode, group, category, ronaldo, orderNum, outCodeSup, flag, activeyn, userId, outcodeOutlet, tglSP, via, depo) => {
        this.setState({
            Spch_NoSP: nosp,
            ...
            return <tr align="center">
                ...
                <td>
                    <Button color="info" size="sm" onClick={() => this.openDetail(todo.SpCordHeader.Spch_NoSP,
                        ...
                        todo.SpCordHeader.Spch_OutCodeDepo)}>Detail</Button>
                </td>
