...
class SPAddHODetail extends React.Component {
    ...
    getDetailDataSPAddHO = () => {
        ...
        // var url =  'http://10.0.111.4:4411/spaddho/data?type=detail&nosp=' + this.props.SpchNoSP + '&outcode=' + this.props.outcode + '&group=' + this.props.group + '&category=' + this.props.category + '&ronaldo=' + this.props.ronaldo + '&depo=' + this.props.depo
                    ...
                    <Col>
                        <Card className="mb-3">
                            <CardHeader className="d-flex justify-content-between">
                                ...
                                <Button color="info" size="sm" onClick={() => this.print(this.state.spID)}><MdPrint /> Print</Button>
                            </CardHeader>
                            <CardHeader className="d-flex justify-content-between">
