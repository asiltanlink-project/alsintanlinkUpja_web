...
class SPHome extends React.Component{
    ...
    getLaporanSPManual = () =>{
        ...
        const url_getReport = 'http://10.0.111.4:3333/sp?'+this.state.selectedTipeLaporan.toLowerCase()+'&flag='+this.state.flag+'&date='+this.state.inputDate+'&gudangid='+this.state.gudangID
    ...
    render(){
        const {tipeLaporan,selectedTipeLaporan,spNotPrintChecked,btnSearchWord,btnSearchIsDisabled} = this.state
        return(
            <Page
            ...
            >
                 <Card>
                    <CardBody>
                        <Row style={{marginTop:'1%'}}>
                            ...
                            <Col>
                            <select className='custom-select' onChange={(e)=>this.handleChange(e,'tipe laporan')}>
                                <option>==PILIH TIPE LAPORAN==</option>
                                {
                                    tipeLaporan && tipeLaporan.map((js)=>
                                    <option>{js.name}</option>
                                    )
                                }
                            </select>
                            </Col>
                ...
                {selectedTipeLaporan==='Manual'&&<Card>
                    <CardHeader>
                    ...
                    <CardBody>
                        <Row>
                            ...
                            <select className='custom-select' onChange={(e)=>this.handleChange(e,'jenis laporan')}>
                            ...
                            <Col>
                            <Input style={{marginTop:'2%'}} type='checkbox' checked={spNotPrintChecked} onChange={(e)=>this.handleChange(e,'sp not print')}/>
                        ...
                        <Row>
                            ...
                            <Col xs={3} style={{paddingLeft:'0px',marginLeft:'0%'}}>
                                <Input type='date' onChange={(e)=>this.handleChange(e,'date')}></Input>
                            </Col>
                            <Col xs={1}>
                            </Col>
                            <Col>
                    ...
                    <Row>
                            ...
                            <Button disabled={btnSearchIsDisabled} onClick={()=>this.getLaporanSPManual()}>
                                {btnSearchIsDisabled &&  <MdAutorenew/>}
                                {btnSearchWord}</Button>
                            </Col>
                            <Col xs={1}>
                            </Col>
                            <Col>
