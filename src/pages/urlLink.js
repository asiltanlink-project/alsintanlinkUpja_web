...
var url_forgetPassword =
  url_alsintanlinkProduction + '/api/upja/forget_password';
...
var url_showDetailUPJA =
  url_alsintanlinkProduction + '/api/upja/show_detail_upja';
...
var url_deleteAlsinItem =
  url_alsintanlinkProduction + '/api/upja/delete_alsin_item';
var url_updateAlsinItem =
  url_alsintanlinkProduction + '/api/upja/update_alsin_item';
var url_allAlsinType =
  url_alsintanlinkProduction + '/api/upja/show_all_alsin_type';
var url_getTransaksi =
  url_alsintanlinkProduction + '/api/upja/show_all_transaction';
var url_getTransaksiDetail =
  url_alsintanlinkProduction + '/api/upja/show_detail_transaction';
var url_showFormPricing =
  url_alsintanlinkProduction + '/api/upja/show_form_pricing';
