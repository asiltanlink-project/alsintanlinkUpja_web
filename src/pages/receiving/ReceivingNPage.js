...
class ReceivingNPage extends React.Component {
  ...
  getDetailPOAgain(group, data, gudangID) {
    ...
    trace.start();
    var url = myUrl1.url_getDaftarReceiving + gudangID + '/' + data.rcvh_norecv;
    ...
    fetch(url, option)
      ...
      .then(data => {
        ...
        if (error.status == false) {
          ...
          this.showNotification(error.msg + 'AAAA', 'error');
        }
      });
  }
  ...
  scanProcod = event => {
    ...
    // if (document.getElementById('satuanSellpack').style.display === 'none') {
                  ...
                  <CardBody id="receivingUpper" style={{ display: 'none' }}>
                    ...
                    <Row md="1" sm="3" xs="3" style={{ marginBottom: '10px' }}>
                      ...
                      <Input
                        ...
                        value={
                          // headerPO &&
                          // headerPO.rcvh_tglfaktur === '0001-01-01T00:00:00Z'
                    ...
                    <Row md="1" sm="3" xs="3" style={{ marginBottom: '10px' }}>
                      ...
                      <Input
                        ...
                        className="text-left"
                        style={{ width: '20%' }}
                        value={headerPO && headerPO.rcvh_tgldo}
                        // value={
                        //   headerPO &&
                    ...
                    >
                      ...
                      <Input
                        ...
                        onKeyDown={event => {
                          if (event.key === 'Enter') {
                            this.getKaryawanData(event.target.value);
